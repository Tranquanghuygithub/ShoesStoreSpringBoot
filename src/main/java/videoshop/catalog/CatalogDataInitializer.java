...
import videoshop.inventory.InventoryInitializer;
...
public class CatalogDataInitializer implements DataInitializer {
	...
	public void addDemo() {
		videoCatalog.save(new Disc("Armour of God III: Operation Condor", "aog2oc", Money.of(14.99, EURO),
				"Action/Adventure/Comedy", DiscType.DVD));
	}
	
	public void updateDemo() {		
		Iterable<Disc> discs = videoCatalog.findAll();
//		
//		//Disc disc = discs.iterator().next();
//		
//		//Disc disc = (Disc) Iterables.getFirst(discs, 1);
//		
		Disc disc = Iterables.get(discs, 1);
		
		
		System.out.println(disc.getName());
		
		disc.setName("Van Hao");
	...
	public void deleteDemo(Inventory<InventoryItem> inventory) {
...
//		videoCatalog.delete(disc);
		...
		InventoryInitializer inventoryInitializer = new InventoryInitializer(inventory, videoCatalog);
		
		//System.out.println(disc.getName());
		
//		for (Disc itemDisc : discs) {
//			System.out.println(itemDisc.getName());
//			System.out.println(itemDisc.getId());
//			
//		}
//		Disc disc = new Disc("Armour of God IIIII: Operation Condor", "aog2oc", Money.of(14.99, EURO),
//				"Action/Adventure/Comedy", DiscType.DVD);
//		videoCatalog.save(disc);
		
		inventoryInitializer.deleteInventoryItem(disc.getId());
		videoCatalog.deleteById(disc.getId());
